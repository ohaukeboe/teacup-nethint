...
traffic_iperf = [
    ...
    ('0.0', '1', " start_iperf, client='pc01', server='pc04', port=5001,"
     " duration=V_duration, extra_params_client='-Z reno' "),
    ('0.0', '2', " start_iperf, client='pc01', server='pc04', port=5002,"
     " duration=V_duration, extra_params_client='-Z cubic' "),
    ('0.0', '3', " start_iperf, client='pc01', server='pc04', port=5003,"
     " duration=V_duration, extra_params_client='-Z bbr' "),

    ('0.0', '4', " start_iperf, client='pc05', server='pc03', port=5001,"
